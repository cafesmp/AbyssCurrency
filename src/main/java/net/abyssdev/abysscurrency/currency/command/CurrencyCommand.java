package net.abyssdev.abysscurrency.currency.command;
...
public final class CurrencyCommand extends Command<CommandSender> {
    ...
    private final AbyssCurrency plugin;
     ...
     */
    public CurrencyCommand(final AbyssCurrency plugin, final Currency currency) {
